  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        {services.map(s => (
          <div key={s.id} className="flex items-center justify-between bg-white border rounded-xl px-4 py-3">
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              {editingId === s.id ? (
                <input
                  ...
                  autoFocus
                  className="flex-1 border border-primary-400 rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              ) : (
